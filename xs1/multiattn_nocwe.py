...
if __name__ == "__main__":
    #run(gen_ndss(), 'ndss', batch_size=80, epochs=20, train_op=True, saving_model = False)
    #run(gen_juliet(), 'juliet', batch_size=12, epochs=20, train_op=False, saving_model = False)
    run(gen_devign(), 'devign', batch_size=12, epochs=20, train_op=True, saving_model = False)
