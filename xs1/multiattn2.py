...
if __name__ == "__main__":
    #run(gen_ndss(), 'ndss', batch_size=80, epochs=50, train_op=False, saving_model = True)
    run(gen_juliet(), 'juliet', batch_size=8, epochs=20, train_op=True, saving_model = True)
