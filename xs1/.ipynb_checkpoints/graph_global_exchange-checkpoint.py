...
from xs1.nodes_to_graph_representation import WeightedSumGraphRepresentation, NodesToGraphRepresentationInput
...
class GraphGlobalExchange(tf.keras.layers.Layer):
    ...
    def _compute_per_node_graph_representations(
        ...
        cur_graph_representations, _ = self._node_to_graph_representation_layer(
            NodesToGraphRepresentationInput(
