...
if __name__ == "__main__":
    #run(gen_ndss(), 'ndss', batch_size=96, epochs=50, train_op=False, saving_model = False)
    #run(gen_juliet(), 'juliet', batch_size=16, epochs=30, train_op=True, saving_model = False)
